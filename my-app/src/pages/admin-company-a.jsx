...
export default function AdminCompanyB() {
  ...
  const getProducts = async () => {
    const res = await fetch("http://localhost:8050/ca/products");
    const data = await res.json();
    setProducts(data);
  };

  const postProduct = async (data) => {
    const res = await fetch("http://localhost:8050/ca/product", {
      method: "POST",
      headers: {
  ...
  const postTransaction = async (data) => {
    const res = await fetch("http://localhost:8050/ca/transaction", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const putProduct = async (data) => {
    const res = await fetch("http://localhost:8050/ca/product/" + idProd, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
